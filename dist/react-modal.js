...
var randomByte = __webpack_require__(26);
...
var GlobalVariable = function () {
  function GlobalVariable(target) {
  ...
  _createClass(GlobalVariable, [{
    ...
    value: function merge(key, value) {
      window.GV[this.target][key] = _immutable2.default.fromJS(_extends({}, window.GV[this.target][key], value)).toJS();
    }
  }, {
    key: 'get',
    ...
    value: function reset() {
      window.GV[this.target] = _immutable2.default.fromJS(_extends({}, this.defaultValue)).toJS();
    }
  }]);
...
var _GlobalVariable = __webpack_require__(5);

var _GlobalVariable2 = _interopRequireDefault(_GlobalVariable);
...
var ModalDOM = function () {
  function ModalDOM(groupId, id, isOverlay) {
    ...
    this.gv = new _GlobalVariable2.default('modalDOM', {
      order: [],
      selected: null
    });
  ...
  _createClass(ModalDOM, [{
    ...
    value: function zIndexUpdate(group, id) {
      ...
      var rootNode = document.getElementById(group);
      var groupNode = Array.from(rootNode.querySelectorAll('[data-modal-container]'));
      var data = groupNode.sort(function (a, b) {
        return a.dataset.modalIndex - b.dataset.modalIndex;
      }).filter(function (node) {
        return node.id === id;
      });
      var frist = Number(groupNode[0].dataset.modalIndex);
      data = _extends([], [thisNode].concat(_toConsumableArray(data)));

      data.forEach(function (node, i) {
        var ele = document.getElementById(node.id);
        var index = frist + i;
        ele.setAttribute('data-modal-index', frist + index);
        ele.querySelector('[data-modal-content]').style.zIndex = _this.zIndex + index;
      });
    }
  }, {
    key: 'update',
    value: function update() {
      ...
      var modalContentNode = document.getElementById(this.id);
    ...
    value: function destroy() {
      var rootNode = document.getElementById(this.group);
      if (rootNode) {
    ...
    key: 'getOrderIndex',
    value: function getOrderIndex(orderId) {
      return this.gv.get('order').findIndex(function (id) {
        return id === orderId;
      });
    }
  }, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_is_function__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_hoist_non_react_statics__ = __webpack_require__(13);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(31), __webpack_require__(18)))

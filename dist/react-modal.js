...
var randomFromSeed = __webpack_require__(80);
...
var _styleModule = __webpack_require__(32);
...
var randomByte = __webpack_require__(79);
...
var doc = document;
var body = doc.body;
var reactModalOverlay = doc.getElementById('react-modal-overlay');
if (!reactModalOverlay) {
  reactModalOverlay = doc.createElement('div');
  reactModalOverlay.setAttribute('id', 'react-modal-overlay');

  body.insertBefore(reactModalOverlay, body.hasChildNodes() ? body.childNodes[0] : null);
}
...
var GroupModal = function (_React$Component) {
  ...
  function GroupModal(props) {
    ...
    var _this = _possibleConstructorReturn(this, (GroupModal.__proto__ || Object.getPrototypeOf(GroupModal)).call(this, props));
  ...
  _createClass(GroupModal, [{
    ...
    key: 'setChildren',
    value: function setChildren(props) {
      var _this2 = this;

      var openCount = 0;

      this.Children = _react2.default.Children.map(props.children, function (children, index) {
        if (getName(children.type) === 'Modal') {
          if (children.props.isOpen) openCount += 1;
          if (!_this2.id[index]) {
            _this2.id[index] = _shortid2.default.generate();
          }

          return _react2.default.cloneElement(children, {
            onModalSelect: _this2.onModalSelect,
            isOverlay: false,
    ...
    value: function render() {
      ...
      var Children = _react2.default.Children.map(this.Children, function (children) {
        if (getName(children.type) === 'Modal') {
          var zIndex = children.props.id === _this3.state.selectId ? _this3.zIndexTop() : _this3.props.zIndex;
          return _react2.default.cloneElement(children, _extends({}, children.props, {
            zIndex: zIndex
          }));
        }
        return children;
      ...
      return _reactDom2.default.createPortal([this.props.isOverlay && this.state.overlay ? _react2.default.createElement(_Overlay2.default, { key: 'reactGroupModalOverlay', zIndex: this.props.zIndex }) : null, Children], this.ele);
    }
  }]);
...
if (!reactModal) {
  ...
  body.insertBefore(reactModal, body.hasChildNodes() ? body.childNodes[0] : null);
}
...
var zIndexUpdate = function zIndexUpdate(zIndex) {
  var modalNode = Array.from(reactModal.querySelectorAll('[data-modal]'));
  var zIndexNew = zIndex === null ? 1 : zIndex + 1;

  modalNode.forEach(function (ele) {
    var node = reactModal.querySelector('[data-modal=' + ele.dataset.modal + ']');
    if (node) {
...
var _GroupModal = __webpack_require__(36);
...
exports.GroupModal = _GroupModal2.default;
...
var STRICT = __webpack_require__(63)([].forEach, true);
...
var build = __webpack_require__(75);
...
var clusterWorkerId = __webpack_require__(81) || 0;

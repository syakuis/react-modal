...
})(this, function(__WEBPACK_EXTERNAL_MODULE_24__, __WEBPACK_EXTERNAL_MODULE_73__, __WEBPACK_EXTERNAL_MODULE_74__, __WEBPACK_EXTERNAL_MODULE_83__) {
...
var randomFromSeed = __webpack_require__(76);
...
var randomByte = __webpack_require__(77);
...
exports.createId = exports.syncModal = undefined;
...
var syncModal = (0, _mobx.observable)({
  modal: [],
  current: (0, _mobx.computed)(function () {
    var firstIndex = 0;
    if (syncModal.modal.length === firstIndex) return null;
    return syncModal.modal[firstIndex];
  }),
  isOpen: function isOpen(id) {
    return syncModal.modal.indexOf(id) > -1;
  },
  open: (0, _mobx.action)('react-modal open', function (id) {
    var modal = syncModal.modal.slice();
  ...
  close: (0, _mobx.action)('react-modal close', function (id) {
    var modal = syncModal.modal.slice();
...
var _withModal = __webpack_require__(72);

var _withModal2 = _interopRequireDefault(_withModal);

var _syncModal = __webpack_require__(37);
...
var open = _syncModal.syncModal.open,
    close = _syncModal.syncModal.close;
exports.default = (0, _withModal2.default)(Modal);
exports.createId = _syncModal.createId;
exports.open = open;
exports.close = close;
...
var withModal = function withModal(Component) {
  var Modal = (0, _mobxReact.observer)(function (_React$Component) {
    ...
    function Modal(props) {
      ...
      _this.isOpen = _syncModal.syncModal.isOpen(_this.id);
      return _this;
    }
    ...
    _createClass(Modal, [{
      ...
      value: function componentWillMount() {
        if (this.props.isOpen) {
          this.onOpen();
          this.isOpen = _syncModal.syncModal.isOpen(this.id);
        }
      ...
      value: function componentDidMount() {
        ...
        if (!this.isScrollBarDisable) (0, _utils.scrollbarHidden)(_syncModal.syncModal);

        if (this.props.isEscClose && this.isOpen && !this.isKeydownEventListener && _syncModal.syncModal.current === this.id) {
          window.addEventListener('keydown', this.onEscClose);
          this.isKeydownEventListener = true;
        }

        if (!this.isResizeEventListener && _syncModal.syncModal.current === this.id) {
          this.onResizeEventListener();
          window.addEventListener('resize', this.onResizeEventListener);
          this.isResizeEventListener = true;
        }

        if (this.id === _syncModal.syncModal.current && this.props.isAutoFocus) this.modal.onFocus();
      }
    }, {
      ...
      value: function componentDidUpdate() {
        ...
        if (this.props.isEscClose) {
          ...
          if (this.isOpen && _syncModal.syncModal.current === this.id) {
            window.addEventListener('keydown', this.onEscClose);
            this.isKeydownEventListener = true;
          }
        }
        ...
        if (_syncModal.syncModal.current === this.id) {
          window.addEventListener('resize', this.onResizeEventListener);
          this.isResizeEventListener = true;
        }
      ...
      value: function onRequestClose() {
        if (typeof this.props.onClose === 'function') {
          ...
          _syncModal.syncModal.close(this.id);
        }
        this.isOpen = false;
      }
    }, {
      ...
      value: function onOpen() {
        _syncModal.syncModal.open(this.id);
      }
    }, {
      key: 'render',
      value: function render() {
        ...
        if (!_syncModal.syncModal.isOpen(this.id)) return null;
...
var decode = __webpack_require__(78);
